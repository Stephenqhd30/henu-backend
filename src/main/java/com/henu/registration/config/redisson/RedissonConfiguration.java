package com.henu.registration.config.redisson;

import com.henu.registration.config.redisson.condition.RedissonCondition;
import com.henu.registration.config.redisson.properties.RedissonProperties;
...
public class RedissonConfiguration {
	...
	public RedissonClient redissonClient() {
		...
		// 使用单节点模式配置
		config.useSingleServer().setAddress(redisAddress).setDatabase(redissonProperties.getDatabase()).setPassword(redissonProperties.getPassword());
